...
- Name: us1-4-delete-review.spec.ts >> US1-4: Delete a review >> empty state appears after deleting the only review
- Location: e2e/us1-4-delete-review.spec.ts:107:7

...
- Name: us1-2-view-reviews.spec.ts >> US1-2: View past reviews >> review cards display date in expected format
- Location: e2e/us1-2-view-reviews.spec.ts:51:7
...
Locator: getByText('6 Apr 2026').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('6 Apr 2026').first()
